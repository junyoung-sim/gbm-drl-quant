...
The following figures are examples of the trading model's up-to-date test performance.
...
***The model's actions and performance may vary with the randomness associated in the valuation series generated by the GBM simulation. Nevertheless, the model's annualized return is reliably within 25-26%.***